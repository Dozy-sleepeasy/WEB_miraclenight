...
function URLredirection(data) {
    ...
    var url = '/sleepreport/report_1002.html?data='+encodeURIComponent(JSON.stringify(jsonData));
...
function updateReport() {    
    ...
    switch (emotion_input) {
        ...
        case 'tired':
            ...
            emotionText.innerText = '이번 주 많이 피곤하셨군요! 미국국립수면재단의 연구에 따르면, 낮에 계속해서 피로를 느끼는 사람들은 수면 패턴이 교란되기 쉽고, 이로 인해 수면의 질이 나빠질 가능성이 높다고 합니다. 결국 이러한 수면의 질은 낮에 또 피곤함을 많이 느끼게 하는 원인이 될 수 있죠. 악순환을 끊을 수 있는 ';
            break;
        case 'stressed':
